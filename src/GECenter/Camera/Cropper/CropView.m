...
@interface CropView () <UIScrollViewDelegate, UIGestureRecognizerDelegate, CropRectViewDelegate>

@property (nonatomic) UIScrollView *scrollView;
@property (nonatomic) UIView *zoomingView;
@property (nonatomic) UIImageView *imageView;

@property (nonatomic) CropRectView *cropRectView;
...
- (void)commonInit
{
    ...
    //添加剪切视图区域
    self.cropRectView = [[CropRectView alloc] init];
...
- (void)setupImageView
{
    ...
    self.zoomingView.contentMode = UIViewContentModeScaleAspectFit;
