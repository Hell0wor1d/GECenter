...
@interface CropRectView ()<ResizeControlViewDelegate>

@property (nonatomic) ResizeControl *topLeftCornerView;
@property (nonatomic) ResizeControl *topRightCornerView;
@property (nonatomic) ResizeControl *bottomLeftCornerView;
@property (nonatomic) ResizeControl *bottomRightCornerView;
@property (nonatomic) ResizeControl *topEdgeView;
@property (nonatomic) ResizeControl *leftEdgeView;
@property (nonatomic) ResizeControl *bottomEdgeView;
@property (nonatomic) ResizeControl *rightEdgeView;
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    for (UIView *subview in subviews) {
        if ([subview isKindOfClass:[ResizeControl class]]) {
...
- (CGRect)cropRectMakeWithResizeControlView:(ResizeControl *)resizeControlView
{
