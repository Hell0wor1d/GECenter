...
//  GECenter
//
//  Created by Kevin Wang on 14-4-11.
...
- (void)updateCreateAccountButtonForTextfield:(UITextField *)textField andUpdatedString:(NSString *)updatedString
{
    ...
    BOOL updatedStringHasContent = false;//[[updatedString trim] length] != 0;
...
//       _titleLabel.attributedText = [[NSAttributedString alloc] initWithString:NSLocalizedString(@"Create an account on WordPress.com", @"NUX Create Account Page 1 Title")];
    ...
    if (_siteAddressField == nil) {
        ...
        _siteAddressField.placeholder = @"网址";
        ...
        _siteAddressWPComLabel.text = @".Pearson.com";
    ...
    if (_createAccountButton == nil) {
        ...
        [_createAccountButton setTitle:@"创建账户" forState:UIControlStateNormal];
...
- (void)layoutControls
{
    ...
    // versus iPads.
    CGFloat textFieldHeight = CreateAccountAndBlogTextFieldPhoneHeight;//IS_IPAD ? CreateAccountAndBlogTextFieldHeight: CreateAccountAndBlogTextFieldPhoneHeight;
    ...
    [CreateAccountAndBlogViewController centerViews:controls withStartingView:_titleLabel andEndingView:_TOSLabel forHeight:viewHeight];
}
